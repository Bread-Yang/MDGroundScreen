...
package com.handmark.pulltorefresh.library.extras.pinnedsectionlistview;
...
//						Color.parseColor("#50a0a0a0"), Color.parseColor("#00a0a0a0") });
				mShadowDrawable = new GradientDrawable(Orientation.TOP_BOTTOM, new int[] { Color.parseColor("#00000000"),
