...
import com.handmark.pulltorefresh.library.extras.swipelistview.SwipeListView;
...
public class PullToRefreshSwipeListView extends PullToRefreshAdapterViewBase<SwipeListView> {
	...
	protected void onReset() {
		getRefreshableView().resetScrolling();
		/**
	...
	protected void handleStyledAttributes(TypedArray a) {
		...
		if (mListViewExtrasEnabled) {
			...
			mHeaderLoadingView.setLoadingDrawable(getContext().getResources().getDrawable(R.drawable.loading));
