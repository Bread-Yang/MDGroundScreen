package com.handmark.pulltorefresh.library.extras.fixedheadtable;
...
import com.handmark.pulltorefresh.library.extras.fixedheadtable.adapter.TableAdapter;
...
public class TableFixHeaders extends ViewGroup {
	...
	public void scrollToRow(int row) {
		scrollBy(scrollX, sumArray(heights, 1, row) - scrollY);
	}

	public void scrollToColumn(int column) {
		scrollBy(sumArray(widths, 1, firstColumn) - sumArray(widths, 1, column), scrollY);
	}
	...
	public void scrollBy(int x, int y) {
		...
		if (mOnScrollListener != null) {
			mOnScrollListener.onScrollChanged(getActualScrollX(), getActualScrollY());
		}
	}
